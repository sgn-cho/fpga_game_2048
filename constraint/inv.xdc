...
set_property -dict {PACKAGE_PIN W22 IOSTANDARD LVCMOS33} [get_ports state[2]]
set_property -dict {PACKAGE_PIN Y22 IOSTANDARD LVCMOS33} [get_ports state[1]]
set_property -dict {PACKAGE_PIN AB22 IOSTANDARD LVCMOS33} [get_ports state[0]]
